...
public class WXTouchHelper extends ItemTouchHelper.Callback {
    ...
    public WXTouchHelper(GridImageAdapter adapter, List<String> imagesList, NestedScrollView scrollView) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        int editTextHeight = SDFileSelecteUtil.getPixelById(R.dimen.article_post_et_h);//recyclerview上面的editText的高度为100
        int buttonHeight = SDFileSelecteUtil.getPixelById(R.dimen.article_post_delete);//删除按钮高度
        /**
         * 【修改 布局没有10dp空白】
