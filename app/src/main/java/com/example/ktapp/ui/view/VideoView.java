package com.example.ktapp.ui.view;
...
public class VideoView extends StandardGSYVideoPlayer {
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        VideoView sampleCoverVideo = (VideoView) gsyBaseVideoPlayer;
    ...
    public GSYBaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        //下面这里替换成你自己的强制转化
        VideoView sampleCoverVideo = (VideoView) super.showSmallVideo(size, actionBar, statusBar);
